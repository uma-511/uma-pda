...
class CommonPreferenceUtils {
  static CommonPreferenceUtils _instance;

  static CommonPreferenceUtils get instance => CommonPreferenceUtils();

  CommonPreferenceUtils._internal();

  factory CommonPreferenceUtils() {
    if (_instance == null) _instance = CommonPreferenceUtils._internal();
    return _instance;
  }
