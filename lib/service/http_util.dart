...
class HttpUtil {
  ...
  post(url, {data, options, cancelToken}) async {
    ...
    Response response;
    try {
      response = await dio.post('http://' + ip + servicePath[url], data: data, options: options, cancelToken: cancelToken);
  ...
  /// 所以参数可选
  // void _cancelRequests(CancelToken token) {
